<template>
    <div class="flex flex-wrap gap-4 md:gap-0">
        <div class="w-full md:w-1/2 bg-neutral-950 p-6 rounded-md md:rounded-e-none text-slate-200 border border-zinc-900 hover:shadow hover:shadow-blue-500 duration-200">
